...
<body>
                        ...
                        <div class="tb card-body table-responsive">
                            <table class="table table-striped text-center table-hover data">
                                ...
                                <tbody>
                                        ...
                                        <td class="Aksi">
                                            ...
                                            <div class="btn-group dropleft">
                                                ...
                                                <ul class="dropdown-menu text-center">
                                                    <?php
                                    echo "<a href='../../src/users/edit.php?user=".$data['nij']."' data-toggle='modal' data-placement='bottom' title='Edit' class='btn aksi edit btn-sm btn-secondary mt-1'><svg data-toggle='tooltip' xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor'
                                    ...
                                    echo "<a href='../../src/users/index.php?konfir=".$data['nij']."' data-toggle='modal' data-target='#staticBackdrophps' data-placement='bottom' title='Hapus'
    ...
    <!-- Modal untuk hapus-->
    <form action="../../src/users/hapus.php" method="POST">
